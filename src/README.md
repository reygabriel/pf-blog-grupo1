...
_Aplicacion web diseñada por el grupo 1 de la comision 7 del informatorio, segunda cohorte de 2023.
Consiste en un blog para la divulgacion de informacion referida a VIDEOJUEGOS
...
* **Blas Manuel Prieto** 
* **Bruno Mario Elias De Bonis Medina** 
* **Claudio Adrian Lopez** 
* **Gabriel Manuel Alejandro Rey** 



También puedes mirar la lista de todos los [contribuyentes](https://github.com/reygabriel/pf-blog-grupo1/graphs/contributors) quíenes han participado en este proyecto. 
